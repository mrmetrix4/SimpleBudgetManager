...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SimpleBudgetManager.SlidingTabsFragment+SamplePagerAdapter, SimpleBudgetManager", SlidingTabsFragment_SamplePagerAdapter.class, __md_methods);
	}


	public SlidingTabsFragment_SamplePagerAdapter ()
	{
		super ();
		if (getClass () == SlidingTabsFragment_SamplePagerAdapter.class)
			mono.android.TypeManager.Activate ("SimpleBudgetManager.SlidingTabsFragment+SamplePagerAdapter, SimpleBudgetManager", "", this, new java.lang.Object[] {  });
	}
